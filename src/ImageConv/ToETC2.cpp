...
bool Conv(const std::string& src_path, const std::string& dst_path)
{
	...
	pimg::TransToETC2 trans(img->GetPixelData(), img->GetWidth(), img->GetHeight(), c, 
		pimg::TransToETC2::RGBA1, false, true);
...
void ToETC2(const std::string& src_path, const std::string& dst_path)
{
